...
public class SectionAcceptanceTest {
    ...
    void 구간등록_case1() {
        // given
        Map<String, Object> params = 노선_생성_매개변수("신분당선", "bg-red-600", 신사역Id, 강남역Id, 10L);
    ...
    void 노선_맨_앞에_구간_추가() {
        // given
        Map<String, Object> params = 노선_생성_매개변수("신분당선", "bg-red-600", 논현역Id, 강남역Id, 10L);
        ExtractableResponse<Response> lineCreationResponse = 노선_생성_Extract(params);
        long lineId = lineCreationResponse.jsonPath().getLong("id");
    ...
    void 중복된_역_등록_불가능() {
        // given
        Map<String, Object> params = 노선_생성_매개변수("신분당선", "bg-red-600", 신사역Id, 논현역Id, 10L);
        ExtractableResponse<Response> lineCreationResponse = 노선_생성_Extract(params);
        long lineId = lineCreationResponse.jsonPath().getLong("id");
